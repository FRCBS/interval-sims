...
create_performance_forest_plot <- function() {
  ...
  new_names <- c(`Economic effect of 6 month deferral` = "E6", `Economic effect of 12 month deferral` = "E12")
  df <- df %>%
  ...
  g <- df %>% ggplot(aes(y=Id, x=value, xmin=low, xmax=high)) + 
    ...
    scale_fill_manual(breaks=c("t6", "t12"), labels=c("Six months", "Twelve months"), values=1:6) + #breaks = new_names) +
    scale_shape_manual(breaks=c("lmm", "dlmm", "dt", "rf"), 
