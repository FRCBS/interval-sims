...
if (use_logistic_regression) {
  prediction_female <- dummy_predictor2(train_female, test_female)  # or would mean Hb be better centering point than deferral threshold
  prediction_male <- dummy_predictor2(train_male, test_male)
} else {
...
```{r}
dummy_result <- process_all_data(dummy2_ids, replicates=100)
```
